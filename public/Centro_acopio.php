...
<body>
    ...
    <div class="app-layout">
        ...
        <aside class="sidebar-panel">
            ...
            <button class="back-button-inline" onclick="history.back()">
            ...
            <div class="sidebar-header">
                ...
                <div class="search-group">
                    <input type="text" id="busqueda" placeholder="Search recycling centers...">
                    <button class="btn-location">My Location</button>
                </div>
            </div>
    ...
    <div id="routing-panel" class="side-panel">
        ...
        <button type="button" class="btn-clear-route">Clear Route</button>
    </div>
